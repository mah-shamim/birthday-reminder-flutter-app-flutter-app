...
class AddExistingContactsPage extends GetView<AddExistingContactsPageController> {
  const AddExistingContactsPage({super.key});
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              controller.contactsPermission().then((value) {
                Settings.isSkip = true;
                Get.offNamed(Routes.bottomPage);
              });
