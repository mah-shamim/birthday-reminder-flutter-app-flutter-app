...
class MyCardDetailPage extends GetView<MyCardDetailPageController> {
  const MyCardDetailPage({super.key});
            ...
            children: [
              ...
              Container(
                ...
                await generatePdfWithImageAndGreeting(
                  ...
                  controller.fontString.isNotEmpty ? controller.fontString.value : 'assets/font/Roboto-Bold.ttf',
                  context,
                );
